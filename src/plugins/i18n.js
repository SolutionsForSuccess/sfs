  ...
  en: {
    ...
    backoffice: {
      ...
      controlPanel: {
        ...
        categories:
          "Manage the different categories of the menus. Categories are related to menu items. A menu item belongs to a category.",
        menuItems:
          "Management of menu items. A menu is made up of categories, and in turn, the menu items are related to the menu through the category to which it belongs.",
        services:
      ...
      options: {
        ...
        manageFunSettings: "Funtionalities",
      ...
      list: {
        ...
        messages: {
          ...
          messageActivareSuccessSuscriptor:
            "Suscriptor was successfully activate",
          messageDesactivareSuccessSuscriptor:
            "Suscriptor was successfully desactivate",
          ...
          messageEditSuccessSuscriptor:
            "The suscriptor was edited successfully",
          ...
          messageCreateSuccessSuscriptor:
            "The suscriptor was created successfully",
      ...
      form: {
        ...
        titles: {
          ...
          deadlinesNotes:
            "Please, ensure that the sumatory of the deadlines is 100.",
        ...
        validate: {
          ...
          nameDuplicate:
            "There is a table with this name. You must change the numbre or the type.",
          firstName: "You must fill first name field",
          lastName: "You must fill last name field",
          confirmPassword:
            "The password and confirm password fields must be equals",
        ...
        marketingMessages: {
          ...
          inKitchen:
            ", hello! Thank you for use our service. Your order is right now in our kitchen.",
          cooked: "Your order is ready. It look like great!",
          delivering:
            "Your order has been delivering right now. Just a few minutes, please",
    ...
    frontend: {
      menu: {
        ...
        mssCreateUser:
          "Customer created successfully, we have sent your new password by mail.",
      ...
      app: {
        ...
        curbside: "Curbside",
        notClient:
          "There are no orders associated with this client. Remember that only registered customer orders can be viewed.",
        ...
        notRestaurantFound:
          "The requested business does not exist. We hope you find one of your preference in our list.",
        all: "All",
      ...
      home: {
        ...
        noProductForReorder:
          "There is no availability of any menu item of this order.",
        noProductAvailable:
          "The following menu items do not appear in the order, because they are not available today.",
      ...
      reservation: {
        ...
        orderCloseToDiscount:
          "This Reservation is close, and you can't use this Quotation Payment.",
        subtotalNotForDiscount:
          "You can't use this Quotation Payment because is biggest to Subtotal.",
      ...
      order: {
        ...
        state: "State",
        messageToast:
          "If you want to be able to consult your order, please Register",
        messgForContact:
          "To know the status changes of your order, insert your Email or Telephone",
        ...
        warningProductsTheOrderToCatering:
          "You are trying to add a menu item that is NOT from the Catering Service. If you want to continue, you will lose the menu items previously added. ",
        warningProductsTheCateringToOrder:
          "You are trying to add a Catering Service menu item. If you want to continue, you will lose the menu items you added previously. ",
      ...
      payment: {
        ...
        goodPayment: "Paid",
        shareText1:
          " shared a payment link for the food order he placed in our business ",
        shareText1a:
          " shared a payment link for the reservation you made at our business  ",
        shareText2:
    ...
    backoffice: {
      ...
      form: {
        ...
        marketingMessages: {
          ...
          delivering:
            "Su orden está siendo entregada en estos momentos. Solo unos minutos más, por favor.",
